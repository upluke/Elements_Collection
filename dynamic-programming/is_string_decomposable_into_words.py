...
# "szzohzqh"	["oh", "zqh", "szz", "szzoh"]	true
# "qqqqqqqq"	["qqq", "qq", "qqqq"]	true
# "xkkvs"	["ksxa", "ksxln", "xkkvs"]	true
# "ddddddd"	["dd", "dddd"]	false


def decompose_into_dictionary_words(domain,
                                    dictionary):
...
print(decompose_into_dictionary_words(
    "szzohzqh", ["oh", "zqh", "szz", "szzoh"]	))
